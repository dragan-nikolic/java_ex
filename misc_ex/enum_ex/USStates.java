...
public enum USStates {
    ...
    USStates(String name, String abbreviation, String dc, String capital, String postalCode) {
        this.name = name;
    ...
    public static USStates getRandomState() {
        Random random = new Random();
        return values()[random.nextInt(values().length)];
    }

    public static USStates BY_NAME(String name) throws IllegalArgumentException {
        for (USStates s: values()) {
